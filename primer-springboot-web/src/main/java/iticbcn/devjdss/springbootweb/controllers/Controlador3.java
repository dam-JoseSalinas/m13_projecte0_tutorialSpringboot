...
import iticbcn.devjdss.springbootweb.service.BaseDatos3Service;
...
public class Controlador3 {
	...
	public String login(Usuario usuario, Model model) {
		if (bd.compruebaUsuario(usuario.getNombre(), usuario.getPassword())) {
			ArrayList<Libro3> libros = bd.getLibros();
	...
	public String insertar(Libro3 libro, Model model) {
		bd.inserta(libro);
		ArrayList<Libro3> libros = bd.getLibros();
	...
	public String modificar2(Libro3 libro, Model model) {
		bd.modifica(libro);
		ArrayList<Libro3> libros = bd.getLibros();
		model.addAttribute("libros", libros);
		model.addAttribute("libro", null);
